...
app = FastAPI(title="OpenClaw Expenses API", version="1.0.0")
...
@app.get("/")
async def root():
    return {"message": "OpenClaw Expenses API", "version": "1.0.0"}

@app.get("/api/v1/expenses", response_model=ApiResponse)
...
@app.get("/api/v1/expenses/summary", response_model=ApiResponse)
...
@app.get("/api/v1/expenses/monthly", response_model=ApiResponse)
...
@app.get("/api/v1/expenses/categories", response_model=ApiResponse)
...
@app.get("/api/v1/expenses/payment-methods", response_model=ApiResponse)
...
@app.get("/api/v1/expenses/timeline", response_model=ApiResponse)
